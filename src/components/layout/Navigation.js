            ...
            <div className="container-fluid">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav classname="mr-auto">
                        ...
                        {auth ? (
                        <>
                            <Link to="/admin" exact className="nav-link">Admin</Link> 
                            <button onClick={logout} className="btn-sm btn-primary ml-lg-3 py-0 mr-auto mt-3 mt-lg-0 logout-btn">Log out</button>
                        </>
                        ) : (
